export const metadata = {
  ...
  description: "Learn about @impruthvi/nodemail, a Laravel-inspired email library for Node.js with TypeScript support, 6 providers, template engines, and queue support.",
};
