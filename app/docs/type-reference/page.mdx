export const metadata = {
  ...
  description: "Complete TypeScript type definitions for laramail including MailConfig, providers, templates, queue, and failover types.",
};

# Type Reference

All types are exported from `laramail` and can be imported directly:
