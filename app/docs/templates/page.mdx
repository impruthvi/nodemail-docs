export const metadata = {
  title: "Template Engines Overview",
  description: "Use Handlebars, EJS, or Pug for dynamic email templates. All engines implement the TemplateEngine interface for consistent usage.",
};
...
```typescript
import { HandlebarsEngine } from 'laramail';
