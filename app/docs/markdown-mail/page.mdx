export const metadata = {
  title: "Markdown Mail",
  description: "Write emails in Markdown with built-in components (Button, Panel, Table). Auto-converts to responsive HTML with CSS inlining.",
};
...
```typescript
import { MarkdownRenderer } from 'laramail';
...
```typescript
import { getDefaultTheme } from 'laramail';
